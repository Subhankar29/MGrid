...
public:
  explicit MGrid(const vector<vector<double>> &metricObject, int numberOfPivots,
                 int numberOfRings, int queryIndex, int numberOfClusters);
  ...
  static void pruneClusters(vector<double> queryObject, double radius,
